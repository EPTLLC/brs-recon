...
class TestRunner:
    ...
    def run_unit_tests(self, verbose: bool = False, coverage: bool = True) -> int:
        ...
        cmd = [
            ...
            "-m",
            "unit or not (integration or slow or network or privileged)",
            "--tb=short",
        ]
    ...
    def run_integration_tests(
        self, verbose: bool = False, include_privileged: bool = False
    ) -> int:
    ...
    def run_specific_test(self, test_path: str, verbose: bool = True) -> int:
        ...
        cmd = ["python", "-m", "pytest", test_path, "--tb=long"]
    ...
    def run_security_tests(self, verbose: bool = False) -> int:
        ...
        cmd = [
            ...
            str(self.tests_dir),
            "-k",
            "security or auth or validation",
            "--tb=short",
        ]
...
Examples:
  ...
  python scripts/run_tests.py check             # Check test environment
    ...
    parser.add_argument(
        "test_path", nargs="?", help="Specific test path (for 'specific' test type)"
    )
    ...
    if args.test_type == "check":
        ...
        return runner.run_integration_tests(
            verbose=args.verbose, include_privileged=args.include_privileged
        )
        ...
        return runner.run_parallel_tests(workers=args.workers, verbose=args.verbose)

...
class PerformanceLogger:
    ...
    def finish_operation(self, operation_id: str, **kwargs) -> Optional[PerformanceMetrics]:
...
class BRSReconLogger:
    ...
    def __init__(
        ...
        if console_output:
            ...
            console_handler.setFormatter(simple_formatter if not structured_format else formatter)
...
if __name__ == "__main__":
    ...
    logger = get_logger(
        level=logging.DEBUG,
        log_file=Path("logs/brs-recon.log"),
    ...
    # Log some messages
    logger.info("Starting network scan", target="192.168.1.0/24", scan_type="comprehensive")
